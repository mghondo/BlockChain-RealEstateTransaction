...
// Declares the RealEstate contract inheriting from ERC1155 for fractional NFT functionality.
contract RealEstate is ERC1155 {
  ...
  function mint(string memory tokenURI) public returns (uint256) {
    // Public function to mint a new property token with 100 shares.
  ...
  function uri(uint256 tokenId) public view override returns (string memory) {
    // Overrides the uri function from ERC1155 to return stored URI.
